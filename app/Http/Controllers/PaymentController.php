...
class PaymentController extends Controller {
	...
	$users_payment = DB::select('select a.name, a.phone_number, a.email, b.time, b.invoice, b.payment_id, b.transaction_code, b.method, b.amount, b.currency, b.sms_provided, b.receipt FROM client a JOIN payment b ON a.client_id=b.client_id');
	...
	$payments = DB::table('payment')->where('client_id', $this->client_id)->get();
	...
	$file_path = 'media/images/business/' . $this->client_id . '/' . $file;
...
// To use your sandbox account set sandbox to true
	...
	try {
	    ...
	    $client_info = DB::select("SELECT c.firstname,c.client_id, c.lastname, c.location, c.email,c.phone_number,c.country  FROM client c WHERE c.client_id='" . $this->client_id . "'");
