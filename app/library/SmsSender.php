...
class SmsSender {
	...
	$message = array("from" =>in_array(strtoupper($this->name),['INETS','SHULESOFT','ERB','karibuSMS','SUFA SCHOOL','ACCLAVIA','MALEWOGROUP','MASEAA','WAT_SACCOS','MFUKOPESA']) ? $this->name:'INETS',
