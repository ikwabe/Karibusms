...
define('SECRET_SALT','KPcXyTXa35RlaDDY33ruXq1722rlOM4C');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','ephraim@inetstz.com');
...
define('DBNAME','karibusms');
define('DBUSER','root');
define('DBPASS','tabita');

# Table prefix
define('TABLE_PREFIX','karibusms_');
