<?php
/**
 * Description of nosession_profile
 *
 *  -----------------------------------------------------
...
?>
@extends('master')
<section class="vbox" style="margin-top: 5em;">
		...
		<section class="vbox"> 
			...
			<div class="tab-content"> <div class="tab-pane active" id="activity">
				<ul class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border"> 
				    <?php
				    $x = 0; /// THIS will  be a profile type
				    if ($x == 1) {
					...
					?>
    				    <h5 align="center">This profile page is PRIVATE. You cannot see messages here</h5>
    				    <br/><h4 align="center">Subscribe to receive updates from <?= $client->name ?></h4>
				    <h6 align="center"><a href="#" id="page_subscribe" class="btn btn-s-md btn-primary btn-rounded">Click to Subscribe</a></h6>
<?php } ?>
		...
		<section class="vbox">
		    <section class="scrollable"> 
			<div class="wrapper"> 
			      <!--<h5>Leave Message to <?= $client->name ?> </h5>-->
...
<!--				    <section class="panel panel-default"> 
      ...
      <form> <textarea class="form-control no-border" rows="3" placeholder="What are you doing..."></textarea> </form> <footer class="panel-footer bg-light lter"> <button class="btn btn-info pull-right btn-sm">POST</button> 
...
<script type="text/javascript">
    $('#page_subscribe').click(function(){
	swal('nice','ds','success');
    });
</script>