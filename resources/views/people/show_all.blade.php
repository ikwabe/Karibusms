        ...
        <div class="tab-pane col-lg-12">
            ...
            <section class="panel panel-default" style="overflow: scroll;"> 
                ...
                <div class="row text-sm wrapper">
                    ...
                    <div class="col-sm-8"> 
                        <h3><?php $type == 'all' ? '' : ucfirst($type) ?></h3>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group  col-lg-6">
                            ...
                            <select class="form-control" name="category" id="select_category">
                                <option value=""></option>
                                <option value="<?= encryptApp('all') ?>">All</option>
                                <?php
                                /*
                                 * -----------------------------------------------------------------
                                ...
                                foreach ($categories as $category) {
                                    ?>
                                    <option value="<?= encryptApp($category->category_id) ?>"><?= $category->name ?></option>
...
<script type="text/javascript">
                                        $('#select_category').change(function () {
                                            var val = $(this).val();
                                            window.location.href = '#people/'+val;
                                        });
                                        other_name = function () {
