...
<!--		    <aside class="bg-light lter b-l aside-md hide" id="notes"> 
	...
	<footer id="footer" class="footer bg-white b-t b-light fixed">
		...
		<span><a href="<?= url('/api') ?>" target="_blank" class="badge">Developers Api</a></span> |
		<span><a data-toggle="ajaxModal" href="<?= url('/api/contact') ?>" class="m-l-sm "><i class="fa fa-comment-o icon-muted"></i> Give us Feedback</a></span>
	    </div>
	    <div class="text-center padder"> 
