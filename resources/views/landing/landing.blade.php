...
<section id="content"> 
    ...
    <div class="bg-gradient" style="background-image: 'http://localhost/karibu_laravel/media/images/app.png';"> 
		...
		Easy to use and effective SMS & Contacts Management platform</div>
...
<!--	    <div class="col-sm-12 col-lg-8">
                ...
                <section id="content" class="m-t-lg wrapper-md animated fadeInUp">
				    ...
				    <span class="alert alert-danger">
                                        <strong>{{ $errors->first('email') }}</strong>
                                            ...
                                            <div class="checkbox">
                                                <label> <input type="checkbox" name="checkbox" checked="checked"> Keep
                                                    me signed in </label>
                                            </div>
            ...
            <div class="dker pos-rlt">
                <div class="container wrapper">
                    <div class="m-t-lg m-b-lg text-center">
                        If you want to send SMS to a number of people easily and effectively, karibuSMS is what you
                        need.
                    </div>
                </div>
            </div>
        ...
        <div class="dker pos-rlt">
            <div class="container wrapper">
                <div class="m-t-lg m-b-lg text-center">
		   If you want to send  SMS to number of people easily and effectively, karibuSMS is a solution for you.</div>
            </div> 
        </div> 
    </div> 
            ...
            <div class="row m-t-xl m-b-xl text-center">
                ...
                <div class="col-sm-4" data-ride="animated" data-animation="fadeInLeft" data-delay="300">
                    ...
                    <div class="">
                        ...
                        <p class="text-muted m-t-lg">Download <a href="https://goo.gl/APJaej" target="_blank" class="label label-info"> here</a> our Mobile app to send Free SMS from our platform to all your contacts  or just use <a class="label label-success" href="<?= HOME ?>api">internet messages</a>  to send SMS  to your contacts.</p> </div> 
                </div>
                ...
                <div class="col-sm-4" data-ride="animated" data-animation="fadeInLeft" data-delay="900"> <p class="h3 m-b-lg"> <i class="fa fa-gears fa-3x text-info"></i> </p> <div class=""> 
                        ...
                        <p class="text-muted m-t-lg">karibuSMS <a href="<?= HOME ?>api" class="label label-info" title="PHP, JAVA and jQuery APIs">Developer APIs</a> allows any of your system/software application to be integrated with karibuSMS and access all powerful features of karibuSMS in your application.</p> </div> </div> 
            </div> 
        </div> </div>
