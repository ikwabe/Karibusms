                    ...
                    <div class="clearfix padder"> 
                        <div id="printstyle1">
                            ...
                            <ul> 
                                ...
                                <li>Bulk SMS send up to 10,000 SMS at once</li>
                        ...
                        <section class="scrollable wrapper">
                            <div class="buttonstn-group btn-group-justified">
                                <div class="col-lg-6 doc-buttons" id='page_info'><a data-toggle="ajaxModal" href="<?= $AJAX ?>&pg=home&section=page_info" class="btn btn-s-md btn-primary">View your page information</a> </div>
                                <div class="col-lg-6 doc-buttons" id='sample_add'><a data-toggle="ajaxModal" href="<?= $AJAX ?>&pg=home&section=sample_add" class="btn btn-s-md btn-info">Your sample add for your business</a></div>
                            </div>
                        </section>

                        <div id="printstyle2">
                            <h4 id="send_sms" class="text-success">How to send sms</h4> 
                            ...
                            <div class="clearfix"> 
                                <?php
                                 echo '<br/> <h5>For karibuSMS messaging</h5>';
                                require_once 'modules/payment/part/smart_costs.php';
                                echo '<br/> <h5>For karibuSMS pro messaging</h5>';
                                require_once 'modules/payment/part/packages.php';
                                ?>
                                <p>These costs include short code number <?=$SUBSCRIPTION_NUMBER?> which your customer will use to subscribe to your page</p>
                                <br/>
                                <h5><strong>More help and support</strong></h5> 
                                <p>
                                    In case you need more help or support please contact us via 
                                    <br/>
                                <ul>
                                    <li>Email:<strong>info@karibusms.com</strong> </li>
                                    <li>Our Company Phone number & whatsapp number:<strong>+255 759 55 33 55</strong> </li>
                                     <li>Or & whatsapp number:<strong>+255 655 40 60 04</strong> </li>
                                </ul>
                                </p> 
                                <p>For any case you need a help, feel free to contact us and we will be glad to assist and support you</p>
                            </div>
                        </div>
                </section>
            </section> 
