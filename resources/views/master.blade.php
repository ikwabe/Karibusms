                ...
                <div class="container text-center m-t-lg">
                    <div class="row m-t-xl m-b-xl"> 
                        ...
                        <div class="col-sm-4" data-ride="animated" data-animation="fadeInUp" data-delay="600"> 
                            ...
                            <p class="text-sm"><a href="mailto:info@karibusms.com">info@karibusms.com</a></p> 
                        </div> 
                        <div class="col-sm-4" data-ride="animated" data-animation="fadeInRight" data-delay="900">
                            ...
                            <p class="text-sm">For any interest <br>
                                Custom Solutions:- <a href="mailto:info@karibusms.com">info@karibusms.com</a></p> 
                            <p class="text-sm">Privacy:- <a href="<?= url('/') ?>/privacy">Open</a></p> 
                            <p class="text-sm">Terms:- <a href="<?= url('/') ?>/terms">Open</a></p> 
                            <p class="text-sm">Company:- <a href="http://inetstz.com">Open</a></p> 
                    ...
                    <div class="m-t-xl m-b-xl">
                        <p> <a target="_blank" href="https://www.facebook.com/karibuSMS" class="btn btn-icon btn-rounded btn-facebook bg-empty m-sm">
                            ...
                            <a target="_blank" href="https://linkedin.com/company/inets" rel="publisher" class="btn btn-icon btn-rounded btn-twitter bg-empty m-sm"><i class="fa fa-linkedin"></i></a>
                        </p> 
                        <p> 
