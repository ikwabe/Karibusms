...
use InteractsWithQueue,
	...
	$messages = DB::select("SELECT a.content, a.phone_number,a.from_smart, a.pending_sms_id, b.username,b.gcm_id FROM pending_sms a JOIN client b ON a.client_id=b.client_id WHERE a.status='0' AND a.message_id='{$this->message_id}'");
